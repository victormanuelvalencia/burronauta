...
def mostrar_estrellas(data):
    ...
    # Canvas más pequeño para dejar espacio al botón
    ...
    for idx, constellation in enumerate(constellations):
        ...
        for star in stars:
            ...
            canvas.create_oval(x - 5, y - 5, x + 5, y + 5, fill=star_color, outline="")
